class MapSwipeMove {
  constructor({ container, transitionClass }) {
    ...
    this.mapClickDown = e => {
      ...
      initialClientX = (e.clientX || e.touches[0].clientX) - mapTranslateX;
      initialClientY = (e.clientY || e.touches[0].clientY) - mapTranslateY;
    };
    this.mapClickMove = e => {
      e.preventDefault();
      if (!_active) return;
    ...
    this.mapClickUp = () => {
      ...
      if (
        ...
        boxPosition.bottom - window.innerHeight + borderScreenLimit < 0 ||
